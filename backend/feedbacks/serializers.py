...
class FeedbackSerializer(serializers.ModelSerializer):
    ...
    def _reward_reviewer(self, reviewer):
        try:
            ...
            profile = reviewer.userprofile
            profile.reputation_score = (profile.reputation_score or 0) + 2
            profile.save(update_fields=['reputation_score'])
            ReputationLog.objects.create(user=reviewer, points=2, reason="Feedback submitted")
        except Exception:
            pass
