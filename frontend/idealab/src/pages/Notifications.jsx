    ...
    <div className='min-h-screen bg-primary'>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease }}>
          ...
          <div className='flex items-end justify-between gap-4'>
            <div>
              ...
              <p className='mt-1 text-sm text-primary/55'>Stay updated on your ideas and community activity.</p>
            </div>
            {unread > 0 && (
              <Button
                size='sm'
      ...
      <div className='mx-auto max-w-3xl px-6 py-8'>
        ...
        {isLoading ? (
          ...
          <EmptyState icon={Bell} title='No notifications' description="You'll be notified when someone interacts with your ideas." />
        )}
