...
const STATUSES = ['', 'submitted', 'validating', 'promising', 'rejected']
const STATUS_LABELS = { '': 'All', submitted: 'Submitted', validating: 'Validating', promising: 'Promising', rejected: 'Rejected' }
...
export default function IdeaFilters({ filters, onChange }) {
  ...
  return (
    <motion.aside
      ...
      className='space-y-6 rounded-2xl border border-secondary/15 bg-primary p-5 shadow-[0_4px_24px_rgba(104,26,21,0.07)]'
    >
      {/* header */}
