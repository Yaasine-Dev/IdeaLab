  ...
  return (
    <>
      <motion.header
        ...
        className='sticky top-0 z-50 border-b border-secondary/15 backdrop-blur-md'
      >
            ...
            <AnimatePresence>
              {openSearch && q.length >= 2 && (
                <motion.div
                  ...
                  className='absolute left-0 right-0 mt-2 max-h-96 overflow-auto rounded-2xl border border-secondary/20 bg-primary p-2 shadow-[0_16px_48px_rgba(104,26,21,0.16)]'
                >
                  {ideas.length > 0 && (
                  ...
                  <AnimatePresence>
                    {openUser && (
                      <motion.div
                        ...
                        transition={{ duration: 0.2, ease }}
                        className='absolute right-0 top-12 w-52 overflow-hidden rounded-2xl border border-secondary/20 bg-primary shadow-[0_16px_48px_rgba(104,26,21,0.16)]'
                      >
                        {/* user info header */}
                        ...
                        <div className='p-1.5'>
                          ...
                          <DropItem icon={Bookmark} label='Bookmarks' to='/bookmarks' onClick={() => setOpenUser(false)} />
                        </div>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              exit={{ x: '-100%' }}
              transition={{ duration: 0.35, ease }}
              className='fixed inset-y-0 left-0 z-[70] flex w-72 flex-col bg-primary shadow-[8px_0_40px_rgba(104,26,21,0.15)] md:hidden'
            >
              {/* drawer header */}
